...
public class App {
	public static void main(String[] args) {
		...
		boolean isHtmlUL = clazz.isAnnotationPresent(HtmlUL.class);

		StringBuilder sb = new StringBuilder();
		if (isHtmlUL) {

			// Lấy ra đối tượng AnnHtmlUL, chú thích trên lớp này.
			HtmlUL annUL = clazz.getAnnotation(HtmlUL.class);
			...
			for (Method method : methods) {
				...
				if (method.isAnnotationPresent(HtmlLI.class)) {
					// Lấy ra annotation đó.
					HtmlLI annLI = method.getAnnotation(HtmlLI.class);
